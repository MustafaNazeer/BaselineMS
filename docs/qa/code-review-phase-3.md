...
**File:** `app/src/main/java/com/mustafanazeer/baselinems/dsp/GaitPipeline.kt`
...
**File:** `app/src/main/java/com/mustafanazeer/baselinems/dsp/ImuSample.kt`
**Lines:** 13 to 14.
...
**File:** `app/src/test/java/com/mustafanazeer/baselinems/dsp/GaitPipelineIntegrationTest.kt`
...
**File:** `app/src/main/java/com/mustafanazeer/baselinems/dsp/ButterworthLowPass.kt`
**Line:** 5.
...
**Files:**
- `app/src/main/java/com/mustafanazeer/baselinems/dsp/GaitPipeline.kt` lines 279, 286.
- `app/src/test/java/com/mustafanazeer/baselinems/dsp/ZuptTest.kt` lines 16, 21, 38, 44.
...
**File:** `app/src/main/java/com/mustafanazeer/baselinems/dsp/FeatureExtractor.kt`
**Lines:** 19 to 22.
...
- `grep -rn "import android" app/src/main/java/com/mustafanazeer/baselinems/dsp/
  app/src/test/java/com/mustafanazeer/baselinems/dsp/
  app/src/test/java/com/mustafanazeer/baselinems/fixtures/` returns nothing.
