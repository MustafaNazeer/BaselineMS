# MS Neuro Battery Phase 3: Gait Signal Processing Implementation Plan
...
**Related spec:** `~/src/MS-Battery/SPEC.md` Section 7 (Gait Module Deep Dive) and Section 6.2 (Gait Test summary).

**Related agent briefs:**
- `~/src/MS-Battery/agents/02-signal-processing-engineer.md` (lead implementer of every DSP module).
- `~/src/MS-Battery/agents/20-test-fixture-engineer.md` (lead designer of the synthetic IMU generator and pre canned fixtures).
- `~/src/MS-Battery/agents/11-performance-engineer.md` (Phase 3 reviewer for allocation free hot paths).
- `~/src/MS-Battery/agents/16-citation-auditor.md` (Phase 3 review of DSP method citations).
...
└── app/src/
    ├── main/java/com/mustafan4x/msbattery/
    │   └── dsp/
...
**Files:**
- Modify: `~/src/MS-Battery/SPEC.md` (already done in Phase 3 prep, this task is a verification step)
- Modify: `~/src/MS-Battery/STATUS.md` (already done in Phase 3 prep, verification step)
- Verify: clean working tree on `main` before TFE dispatch

- [ ] **Step 1: Verify SPEC.md Section 6.1 amendment is committed**

Run: `cd ~/src/MS-Battery && git log --oneline -3`
...
Run: `grep "^| 3 " ~/src/MS-Battery/STATUS.md`
...
**Files:**
- Create: `app/src/main/java/com/mustafan4x/msbattery/dsp/Vector3.kt`
- Create: `app/src/main/java/com/mustafan4x/msbattery/dsp/Quaternion.kt`
- Create: `app/src/main/java/com/mustafan4x/msbattery/dsp/ImuSample.kt`
- Create: `app/src/test/java/com/mustafan4x/msbattery/fixtures/.gitkeep` (placeholder so the package directory exists before SyntheticImu.kt lands)
- Create: `app/src/test/java/com/mustafan4x/msbattery/dsp/.gitkeep` (same reason for the DSP test package)
...
```bash
mkdir -p app/src/test/java/com/mustafan4x/msbattery/fixtures
mkdir -p app/src/test/java/com/mustafan4x/msbattery/dsp
touch app/src/test/java/com/mustafan4x/msbattery/fixtures/.gitkeep
touch app/src/test/java/com/mustafan4x/msbattery/dsp/.gitkeep
```

- [ ] **Step 5: Verify the build compiles**

Run: `cd ~/src/MS-Battery && JAVA_HOME=/snap/android-studio/209/jbr ./gradlew :app:compileDebugKotlin`
Expected: BUILD SUCCESSFUL.

- [ ] **Step 6: Commit**

```bash
git add app/src/main/java/com/mustafan4x/msbattery/dsp/Vector3.kt \
        app/src/main/java/com/mustafan4x/msbattery/dsp/Quaternion.kt \
        app/src/main/java/com/mustafan4x/msbattery/dsp/ImuSample.kt \
        app/src/test/java/com/mustafan4x/msbattery/fixtures/.gitkeep \
        app/src/test/java/com/mustafan4x/msbattery/dsp/.gitkeep
...
**Files:**
- Create: `app/src/test/java/com/mustafan4x/msbattery/fixtures/SyntheticImu.kt`
- Create: `app/src/test/java/com/mustafan4x/msbattery/fixtures/SyntheticImuTest.kt`
...
Run: `cd ~/src/MS-Battery && JAVA_HOME=/snap/android-studio/209/jbr ./gradlew :app:testDebugUnitTest --tests com.mustafan4x.msbattery.fixtures.SyntheticImuTest`
...
```bash
git add app/src/test/java/com/mustafan4x/msbattery/fixtures/SyntheticImu.kt \
        app/src/test/java/com/mustafan4x/msbattery/fixtures/SyntheticImuTest.kt
git rm app/src/test/java/com/mustafan4x/msbattery/fixtures/.gitkeep
...
**Files:**
- Create: `app/src/test/java/com/mustafan4x/msbattery/fixtures/PreCannedFixtures.kt`
...
Run: `cd ~/src/MS-Battery && JAVA_HOME=/snap/android-studio/209/jbr ./gradlew :app:testDebugUnitTest --tests "com.mustafan4x.msbattery.fixtures.*"`
Expected: 4 tests, 0 failures.

- [ ] **Step 3: Commit**

```bash
git add app/src/test/java/com/mustafan4x/msbattery/fixtures/PreCannedFixtures.kt
...
Run: `cd ~/src/MS-Battery && git log --oneline -5`
...
**Files:**
- Create: `app/src/main/java/com/mustafan4x/msbattery/dsp/ButterworthLowPass.kt`
- Create: `app/src/test/java/com/mustafan4x/msbattery/dsp/ButterworthLowPassTest.kt`
...
Run: `cd ~/src/MS-Battery && JAVA_HOME=/snap/android-studio/209/jbr ./gradlew :app:testDebugUnitTest --tests com.mustafan4x.msbattery.dsp.ButterworthLowPassTest`
...
```bash
git add app/src/main/java/com/mustafan4x/msbattery/dsp/ButterworthLowPass.kt \
        app/src/test/java/com/mustafan4x/msbattery/dsp/ButterworthLowPassTest.kt
...
**Files:**
- Create: `app/src/main/java/com/mustafan4x/msbattery/dsp/Madgwick.kt`
- Create: `app/src/test/java/com/mustafan4x/msbattery/dsp/MadgwickTest.kt`
...
```bash
git add app/src/main/java/com/mustafan4x/msbattery/dsp/Madgwick.kt \
        app/src/test/java/com/mustafan4x/msbattery/dsp/MadgwickTest.kt
...
**Files:**
- Create: `app/src/main/java/com/mustafan4x/msbattery/dsp/WorldFrame.kt`
- Create: `app/src/test/java/com/mustafan4x/msbattery/dsp/WorldFrameTest.kt`
...
```bash
git add app/src/main/java/com/mustafan4x/msbattery/dsp/WorldFrame.kt \
        app/src/test/java/com/mustafan4x/msbattery/dsp/WorldFrameTest.kt
...
**Files:**
- Create: `app/src/main/java/com/mustafan4x/msbattery/dsp/StepDetector.kt`
- Create: `app/src/test/java/com/mustafan4x/msbattery/dsp/StepDetectorTest.kt`
...
```bash
git add app/src/main/java/com/mustafan4x/msbattery/dsp/StepDetector.kt \
        app/src/test/java/com/mustafan4x/msbattery/dsp/StepDetectorTest.kt
...
**Files:**
- Create: `app/src/main/java/com/mustafan4x/msbattery/dsp/StridePairing.kt`
- Create: `app/src/test/java/com/mustafan4x/msbattery/dsp/StridePairingTest.kt`
...
```bash
git add app/src/main/java/com/mustafan4x/msbattery/dsp/StridePairing.kt \
        app/src/test/java/com/mustafan4x/msbattery/dsp/StridePairingTest.kt
...
**Files:**
- Create: `app/src/main/java/com/mustafan4x/msbattery/dsp/Zupt.kt`
- Create: `app/src/test/java/com/mustafan4x/msbattery/dsp/ZuptTest.kt`
...
class ZuptTest {
    ...
    private fun pipelineRecoveredMeanStrideLength(fixture: com.mustafan4x.msbattery.fixtures.SyntheticImu): Double {
...
```bash
git add app/src/main/java/com/mustafan4x/msbattery/dsp/Zupt.kt \
        app/src/test/java/com/mustafan4x/msbattery/dsp/ZuptTest.kt
...
**Files:**
- Create: `app/src/main/java/com/mustafan4x/msbattery/dsp/FeatureExtractor.kt`
- Create: `app/src/main/java/com/mustafan4x/msbattery/dsp/GaitFeatures.kt`
- Create: `app/src/test/java/com/mustafan4x/msbattery/dsp/FeatureExtractorTest.kt`
...
```bash
git add app/src/main/java/com/mustafan4x/msbattery/dsp/FeatureExtractor.kt \
        app/src/main/java/com/mustafan4x/msbattery/dsp/GaitFeatures.kt \
        app/src/test/java/com/mustafan4x/msbattery/dsp/FeatureExtractorTest.kt
...
**Files:**
- Create: `app/src/main/java/com/mustafan4x/msbattery/dsp/GaitPipeline.kt`
- Create: `app/src/test/java/com/mustafan4x/msbattery/dsp/GaitPipelineIntegrationTest.kt`
...
```bash
git add app/src/main/java/com/mustafan4x/msbattery/dsp/GaitPipeline.kt \
        app/src/test/java/com/mustafan4x/msbattery/dsp/GaitPipelineIntegrationTest.kt
