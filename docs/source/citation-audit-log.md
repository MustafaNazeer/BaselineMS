...
### P3.2. Madgwick 2010 in `app/src/main/java/com/mustafan4x/msbattery/dsp/Madgwick.kt` source comment

- Artifact and lines: `app/src/main/java/com/mustafan4x/msbattery/dsp/Madgwick.kt` lines 6 to 22 (the class level KDoc).
...
### P3.3. Skog et al. 2010 in `app/src/main/java/com/mustafan4x/msbattery/dsp/Zupt.kt` source comment

- Artifact and lines: `app/src/main/java/com/mustafan4x/msbattery/dsp/Zupt.kt` lines 3 to 11 (the class level KDoc).
